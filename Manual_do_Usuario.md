...
* **Backup em Nuvem:** Seus dados são salvos automaticamente na nuvem segura (Azure CosmosDB). Nunca mais perca seu histórico.
...
R: Não! O GC Driver funciona totalmente offline. A internet é usada apenas para sincronização do backup na nuvem.
...
Para guias mais detalhados de cada módulo, acesse:
- 📘 **[Manual por Módulos](Manual/Default.md)**
